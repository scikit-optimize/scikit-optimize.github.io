...
```
    ...
    /home/ubuntu/scikit-optimize/skopt/optimizer/optimizer.py:175: UserWarning: The objective has been evaluated at this point before.
...
```
    ...
    Compressed with gz:  21005 bytes
