...
```
    ...
    Without compression: 68897 bytes
    Compressed with gz:  16809 bytes
...
```
    ...
    Loaded object:  dict_keys(['verbose', 'n_calls', 'acq_optimizer', 'callback', 'acq_func', 'y0', 'n_points', 'n_restarts_optimizer', 'xi', 'dimensions', 'n_random_starts', 'n_jobs', 'kappa', 'base_estimator', 'random_state', 'x0'])
    Local variable: dict_keys(['acq_optimizer', 'verbose', 'acq_func', 'xi', 'dimensions', 'kappa', 'random_state', 'func', 'callback', 'n_calls', 'y0', 'n_points', 'n_restarts_optimizer', 'base_estimator', 'n_random_starts', 'n_jobs', 'x0'])
